...
// Example sample data for nuts products
const products = [
  {
    id: 1,
    name: "Almonds",
...
<template>
  <div class="container mx-auto">
    ...
    <div class="text-center py-10">
      <h1 class="text-4xl text-blue-600 font-bold">Welcome to Nutty Delights</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <!-- Content -->
        <div class="p-4">
          <h3 class="text-lg font-bold text-blue-600">{{ product.name }}</h3>
          ...
          <div class="flex flex-wrap mt-4 space-x-2">
            <span
                ...
                :key="tag"
                class="bg-blue-100 text-blue-600 text-sm px-3 py-1 rounded-full"
            >
              {{ tag }}
            </span>
          </div>
